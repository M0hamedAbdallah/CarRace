...
=======
    ...
    int innx = 0;
>>>>>>> 33b7d490a387ba2b9402f04eeefc975bc3251a6c
    int life = 4;
    int life2 = 5;
    int life3 = 6 ;
    int cnt = 0;
...
//                }
        ...
        if (singlePlayer) {
            if ((mx > 180 && mx < 500) && (my > (284) && my < (315))) {
                System.out.println("Hard lever");
                hardlevel = true;
                singlePlayer = false;
                startTime = 0;
                startTime = System.currentTimeMillis();
            } else if ((mx > 86 && mx < 154) && (my > (613) && my < (677))) {
                System.out.println("back");
                home = true;
                singlePlayer = false;
            } else if ((mx > 521 && mx < 607) && (my > (614) && my < (672))) {
                System.out.println("sound");
                if (musicOn) {
                    musicOn = false;
                    stopMusic();
            ...
            } else if ((mx > 190 && mx < 500) && (my > (365) && my < (430))) {
                System.out.println("Medium Level");
                mediumLevel = true;
                singlePlayer = false;
            } else if ((mx > 185 && mx < 489) && (my > (490) && my < (550))) {
...
>>>>>>> 786583caad2e71f437df063e2422d3ee2747c4c8
        }
        if (hardlevel) {
            if ((mx > 33 && mx < 74) && (my > (613) && my < (649))) {
                if (!puase) {
